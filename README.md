...
<p align="center">Este é um dashboard público utilizado para cadastro de públicações afim de ser utilizado em sites no formato blog, ele contempla um template básico assim com menus para inclusão, edição, exclusão de públicações
</p>
...
## Screenshots
---
  <img width="100%" src="screenshots/demo.gif" >
